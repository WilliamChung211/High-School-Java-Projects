...
public class BattleShip implements TwoPlayerGame{
	...
	public BattleShip(String player1, String player2){
		...
		players[0] = new BattlePlayer(player1);
		players[1] = new BattlePlayer(player2);
	}
	...
	public boolean deterWinner(int playerInd){

		if (players[playerInd%2].checkIfGameOver()){
			
			System.out.println("All of the ships of " + players[(playerInd+1)%2].getName() + " are sunk. " + players[(playerInd)%2].getName() + " wins!"  );
